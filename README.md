...
use [our template on Github](https://github.com/gamepark/board-rivality)
...
- `Rivality` => `Name of your Game`
- `Rivality` => `NameOfYourGame`
- `rivality` => `name-of-your-game`
...
Once you have one Material type and one Location type, you can start to setup a new game in [RivalityRules.ts](/rules/src/RivalityRules.ts)
